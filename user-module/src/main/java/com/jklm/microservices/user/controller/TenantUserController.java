...
import com.jklm.microservices.user.model.Error;
import com.jklm.microservices.user.model.IValue;
import com.jklm.microservices.user.model.Result;
import com.jklm.microservices.user.service.TenantUser;
import com.jklm.microservices.user.service.TokenService;
...
public class TenantUserController {
  ...
  public ResponseEntity<? extends IValue> book(@PathVariable("tenant") String tenant,
    ...
    try {
      ...
      Result<Map<String, Object>> result = tenantUserService.registerFleetForUser(tenant, username,
